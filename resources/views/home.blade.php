    ...
    <body>
            ...
            <div class="w-full max-w-[160rem] flex items-center m-auto px-16 justify-between">
                ...
                <div class="flex gap-12">
                    ...
                    <div class="h-48 p-1 border border-white/12 w-max items-center rounded-full">
                        <a href="https://soapy-fog-63f.notion.site/Lewis-Warren-e1d45d2cedc940269a57283ee9fccbb5" target="_blank" class="text-14 text-white/80 font-light bg-white/2 rounded-full h-full px-16 inline-flex items-center shadow-2xl hover:bg-white/4 hover:shadow-purple-500/40">
        ...
        <section id="projects" class="w-full max-w-fixed m-auto flex flex-col items-center gap-56 my-120 md:my-200 px-16 xl:px-0">
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-64 md:gap-40 lg:gap-64 items-center justify-between">
                ...
                <a href="https://spinupwp.com" target="_blank" class="w-full gap-24 flex flex-col">
                    <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/project-spinupwp.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" alt="SpinupWP Project" width="1120" height="480"/>
                ...
                <a href="https://deploymenthawk.com" target="_blank" class="w-full gap-24 flex flex-col">
                    <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/project-deploymenthawk.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" alt="DeploymentHawk Project" width="1120" height="480"/>
                    <div class="flex flex-col gap-16">
                        <div class="w-full flex items-center justify-between">
                ...
                <div class="w-full gap-24 flex flex-col">
                    <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/project-game.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" alt="Game Project" width="1120" height="480"/>
                    <div class="flex flex-col gap-16">
                        <div class="w-full flex items-center justify-between">
        ...
        <section id="games" class="w-full max-w-fixed m-auto flex flex-col items-center gap-56 my-120 md:my-200 px-16 xl:px-0">
            ...
            <div class="w-full grid grid-cols-2 md:grid-cols-4 gap-24 sm:gap-40 items-center justify-between">
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/game-hollowknight.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Hollow Knight" alt="Hollow Knight Cover Art" width="480" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/game-godofwar2.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="God of War: Ragnorak" alt="God of War: Ragnorak Cover Art" width="480" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/game-reddead2.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Red Dead Redemption 2" alt="Red Dead Redemption 2 Cover Art" width="480" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/game-lastofus.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="The Last of Us" alt="The Last of Us Cover Art" width="480" height="320"/>
            </div>
        </section>
        ...
        <section id="albums" class="w-full max-w-fixed m-auto flex flex-col items-center gap-56 my-120 md:my-200 px-16 xl:px-0">
            ...
            <div class="w-full grid grid-cols-3 md:grid-cols-6 items-center gap-24 sm:gap-40 md:gap-24 lg:gap-40">
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-madeon.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Madeon - Adventure Album" alt="Madeon Album Artwork" width="320" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-daftpunk.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Daft Punk - Alive Album" alt="Daft Punk - Alive Album Artwork" width="320" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-foofighters.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Foo Fighters - The Colour and the Shape Album" alt="Foo Fighters - The Colour and the Shape Album Artwork" width="320" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-pinkfloyd.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Pink Floyd - Dark Side of the Moon Album" alt="Pink Floyd - Dark Side of the Moon Album Artwork" width="320" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-fosterthepeople.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Foster the People - Torches Album" alt="Foster the People - Torches Album Artwork" width="320" height="320"/>
                <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/webp/album-deadmau5.webp') }}" class="w-full shadow-default rounded-xl border border-white/4" title="Deadmau5 - Random Album Title" alt="Deadmau5 - Random Album Title Artwork" width="320" height="320"/>
            </div>
        </section>
